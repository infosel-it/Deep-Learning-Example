...
data_reader = PDataReader("inputi18n.txt", seq_length)        
rnn = PRNN(hidden_size=20, vocab_size=data_reader.vocab_size,seq_length=seq_length,learning_rate=1e-1)
rnn.train(data_reader)

retval = rnn.predict(data_reader, 'i', 19)
print("Predicted Word:",retval)