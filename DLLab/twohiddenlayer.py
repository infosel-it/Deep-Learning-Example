...
class FirstFFNetwork:
  ...
  def grad(self, x, y):
    ...
    self.db4 = (self.h5-y) * self.h5*(1-self.h5) * self.w10 * self.h4*(1-self.h4)
     ...
     # H1 Backpropogation
    self.dw15 = (self.h3-y) * self.h3*(1-self.h3) * self.w5 * self.h1*(1-self.h1) * self.x1
    self.dw17 = (self.h3-y) * self.h3*(1-self.h4) * self.w7 * self.h1*(1-self.h1) * self.x1
    self.dw1 = self.dw15 + self.dw17
    self.dw25 = (self.h3-y) * self.h3*(1-self.h3) * self.w5 * self.h1*(1-self.h1) * self.x2
    self.dw27 = (self.h3-y) * self.h3*(1-self.h4) * self.w7 * self.h1*(1-self.h1) * self.x2
    self.dw2 = self.dw25 + self.dw27
    
    self.db15 = (self.h3-y) * self.h3*(1-self.h3) * self.w5 * self.h1*(1-self.h1)
    self.db17 = (self.h3-y) * self.h3*(1-self.h4) * self.w7 * self.h1*(1-self.h1)  
    self.db1 = self.db15 + self.db17

    # H2 Backpropogation
    self.dw36 = (self.h3-y) * self.h3*(1-self.h3) * self.w6 * self.h2*(1-self.h2) * self.x1
    self.dw38 = (self.h3-y) * self.h3*(1-self.h4) * self.w8 * self.h2*(1-self.h2) * self.x1
    self.dw3 = self.dw36 + self.dw38
    
    self.dw46 = (self.h3-y) * self.h3*(1-self.h3) * self.w6 * self.h2*(1-self.h2) * self.x2
    self.dw48 = (self.h3-y) * self.h3*(1-self.h4) * self.w8 * self.h2*(1-self.h2) * self.x2
    self.dw4 = self.dw46 + self.dw48
    
    self.db26 = (self.h3-y) * self.h3*(1-self.h3) * self.w6 * self.h2*(1-self.h2)
    self.db28 = (self.h3-y) * self.h3*(1-self.h4) * self.w8 * self.h2*(1-self.h2)
    self.db2 = self.db26 + self.db28
